...
public abstract class PlinthVariant extends ExteriorVariantSchema {
    ...
    public Vec3d adjustPortalPos(Vec3d pos, byte direction) {
        return switch (direction) {
            case 0 -> pos.add(0, -0.3, -0.4); // NORTH
            case 1, 2, 3 -> pos.add(0.35f, -0.3, -0.35f); // NORTH EAST p n
            case 4 -> pos.add(0.2, -0.3, 0); // EAST
            case 5, 6, 7 -> pos.add(0.35f, -0.3, 0.35f); // SOUTH EAST p p
            case 8 -> pos.add(0, -0.3, 0.4); // SOUTH
            case 9, 10, 11 -> pos.add(-0.35f, -0.3, 0.35f); // SOUTH WEST n p
            case 12 -> pos.add(-0.4, -0.3, 0); // WEST
            case 13, 14, 15 -> pos.add(-0.35f, -0.3, -0.35f); // NORTH WEST n n
            default -> pos;
        };
    }
