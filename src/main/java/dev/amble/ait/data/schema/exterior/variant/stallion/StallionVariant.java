...
public abstract class StallionVariant extends ExteriorVariantSchema {
    ...
    public Vec3d adjustPortalPos(Vec3d pos, byte direction) {
        return switch (direction) {
            case 0 -> pos.add(0, 0.02, -0.5); // NORTH
            case 1, 2, 3 -> pos.add(0.38, 0.02, -0.38); // NORTH EAST p n
            case 4 -> pos.add(0.5, 0.02, 0); // EAST
            case 5, 6, 7 -> pos.add(0.38, 0.02, 0.38); // SOUTH EAST p p
            case 8 -> pos.add(0, 0.02, 0.5); // SOUTH
            case 9, 10, 11 -> pos.add(-0.38, 0.02, 0.38); // SOUTH WEST n p
            case 12 -> pos.add(-0.5, 0.02, 0); // WEST
            case 13, 14, 15 -> pos.add(-0.38, 0.02, -0.38); // NORTH WEST n n
            default -> pos;
        };
    }
    @Override
